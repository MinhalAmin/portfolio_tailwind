...
export default function Contact(){
    return(
        <div className="bg-teal-950 h-screen md:h-screen max-w-screen-2xl mx-auto">
      <h1 className="text-white text-6xl font-extrabold font-sans text-center">
        CONTACT ME
      </h1>
      <div className="flex flex-col space-y-7 pt-10 pl-28 md:pl-[27rem] text-white font-sans font-bold
      text-lg underline tracking-wider ">
