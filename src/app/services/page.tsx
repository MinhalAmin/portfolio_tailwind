    ...
    <div className="bg-teal-950 md:h-screen max-w-screen-2xl mx-auto 
     ...
     <Image className="place-self-center"
      width="150" height="150" src="/webdev.png" alt="services" />
       <h1 className="text-white font-sans font-extrabold text-2xl pt-3 text-centre pl-12 ">
       Web Development</h1>
       <p className=" text-white text-sm font-medium font-sans tracking-tighter
             pt-4">
        ...
        <Image className="place-self-center"
         width="150" height="150" src="/ui.png" alt="services" />
          <h2 className="text-white font-sans font-extrabold  text-2xl pt-3 pl-14">
            UI/UX Design
        </h2>
        ...
        <h3 className="text-white font-sans font-extrabold text-2xl pt-3 pl-6">
            SEO Optimization
        </h3>
        <p className=" text-white text-sm font-medium font-sans  tracking-tighter
              pt-4">
